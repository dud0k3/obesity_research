...
* **Гипотеза 8 - ПОДТВЕРДИЛАСЬ** 
  График показывает, что точность модели расти перестает уже после добавления первых 4–5 ключевых фичей образа жизни. Оставив все 15+ One-Hot признаков, не получили больший скор чем при меньшем кол-ве признаков
